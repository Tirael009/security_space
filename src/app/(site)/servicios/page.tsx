...
import {
  ShieldCheck, Radar, FileCheck, ShieldHalf, GraduationCap, Code2, ShieldAlert,
  Network, LockKeyhole, PanelsTopLeft, ServerCog, Shield, PanelTop, CircuitBoard, ScanLine,
} from 'lucide-react';
...
function getIcon(name?: string) {
  switch (name) {
    case 'pentest': return ShieldCheck;
    case 'asm': return Radar;
    case 'qa': return FileCheck;
    case 'radar': return Radar;
    case 'shield-half': return ShieldHalf;
    case 'graduation-cap': return GraduationCap;
    case 'code2': return Code2;
    case 'shield-alert': return ShieldAlert;
    case 'network': return Network;
    case 'lock-keyhole': return LockKeyhole;
    case 'panels-top-left': return PanelsTopLeft;
    case 'server-cog': return ServerCog;
    case 'shield': return Shield;
    case 'panel-top': return PanelTop;
    case 'circuit-board': return CircuitBoard;
    case 'scan-line': return ScanLine;
